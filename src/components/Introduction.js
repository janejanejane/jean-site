...
export function Introduction() {
    return (
        <div className="profile-overview__intro">
            ...
            <p>I’m an experienced software developer. My professional background is mostly on front-end web development. But I've also done server-side development using Ruby on Rails, PHP, JavaScript, to name a few.</p>
